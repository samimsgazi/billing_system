                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form method="post" action="mysuperscript.php" autocomplete="on"> 
                               ...
                               <!-- register link --> <p class="change_link">
									Not a member yet ?
                        ...
                        <div id="register" class="animate form">
                            <form  action="mysuperscript.php" method="post" autocomplete="on"> 
                                ...
                                <p> 
                                    <label for="emailsignup" class="youmail" data-icon="e" > Your email(username)</label>
                                    <input id="emailsignup" name="emailsignup" required type="email" placeholder="mysupermail@mail.com"/> 
                                </p>
                                 <p> 
                                    <label for="addsignup" class="youmail" data-icon="e" > Address</label>
                                    <input id="addsignup" name="addsignup" required type="text" placeholder="Kolkata, India"/> 
                                </p>
                                <p> 
                                    <label for="phsignup" class="youmail" data-icon="e" > Mobile</label>
                                    <input id="phsignup" name="phsignup" required type="text" placeholder="1234567890"/> 
                                </p>
                                <p> 

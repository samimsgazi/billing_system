...
$id=$_GET['id'];
$chk=mysql_query("SELECT * FROM prod_master WHERE  prod_id = '$id' ");
...
//if(!$_POST['name']="" && !$_POST['address'] ="" ){
  ...
  $res = " UPDATE prod_master SET prod_name='$prdname', prgroup_id='$prdgroup' WHERE prod_id='$id'";
    ...
    window.location.href='../product-master.php';
    </SCRIPT>");
	}
	else{
		?>
        ...
        <form class="form-basic" method="post" action="#">
            ...
            <div class="form-row">
                <label>
                    ...
                    <input type="text" name="prdname" value=" <?php echo $rec['prod_name']; ?>"  required>
                </label>
            </div>

...
$rec=mysql_fetch_assoc(mysql_query("SELECT * FROM serv_bill_master WHERE id='$id'"));
$trans=mysql_query("SELECT * FROM service_bill_trans WHERE serv_bill_id='$bill'");
...
?>
          ...
          Ph- <?php echo $com['ph_no']; ?><br>Email: <?php echo $com['email']; ?>
           ...
           <tr>
           <td>Invoice No: <?php echo $rec['serv_bill_no']; ?> </td>  <td align="right"> Date: <?php echo $rec['bill_date'];?></td>
           </tr>
           <tr>
